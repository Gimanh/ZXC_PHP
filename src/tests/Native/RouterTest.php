...
class RouterTest extends TestCase
{
    ...
    public function __construct($name = null, array $data = [], $dataName = '')
    {
        ...
        $this->router->prepare($routerConfig);
    ...
    public function testRouteIndex()
    {
        ...
        $this->assertSame($indexRoute->getMiddlewaresAliases(), null);
    ...
    public function testUserProfileRoute()
    {
        ...
        $this->assertSame($userProfileRoute->getMiddlewaresAliases(),
    ...
    public function testUserRoute()
    {
        ...
        $this->assertSame($userRoute->getMiddlewaresAliases(),
    ...
    public function testUserProfile2()
    {
        ...
        $this->assertSame($userProfileRoute2->getMiddlewaresAliases(),
